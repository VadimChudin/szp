...
void LoadAccumulationFromFile()
{
   ...
   while(true)
   {
      ...
      if(!ObjectCreate(name, OBJ_RECTANGLE, 0, t1, top, t2, bottom)) continue;
...
void DrawSingleZone(int index)
{
   ...
   if(ShowPriceLabels)
   {
      ...
      datetime labelTime  = AnchorBar() - PeriodSeconds() * 10;
      double   labelPrice = (LabelAboveLine ? MathMax(price, top) : MathMin(price, bottom))
